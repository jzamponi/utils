...
imregrid('band6/clean.image', template='band6/band6.alma.cycle4.7.skymodel.flat', 
         output='band6/clean.image.modelsize', overwrite=True)

exportfits('band6/clean.image.modelsize', fitsimage='alma_I.fits', dropstokes=True, overwrite=True)
